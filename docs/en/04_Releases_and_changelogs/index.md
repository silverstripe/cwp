...
| -------------- | ----------- | ------------ | ----------------- |
| [1.2.0](cwp_recipe_basic_1.3.0) | Tracks the Framework release 3.3.0. | TBC | current |
| [1.2.0](cwp_recipe_basic_1.2.0) | Tracks the Framework release 3.2.1 and includes minor security fixes. | 9/12/2015 | TBC |
