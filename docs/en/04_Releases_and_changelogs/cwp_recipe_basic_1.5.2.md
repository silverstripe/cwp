...
This upgrade includes CMS and Framework version 3.5.2 which includes bugfixes and 
some minor feature and API enhancements.

 * [framework 3.5.2](https://github.com/silverstripe/silverstripe-framework/blob/3.5/docs/en/04_Changelogs/3.5.2.md)
